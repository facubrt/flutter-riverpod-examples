      ...
      body: Center(
        child: Column(
          children: [
            ...
            IconButton(
              icon: darkMode ? const Icon( Icons.dark_mode_outlined, size: 100 ) : const Icon( Icons.light_mode_outlined, size: 100 ),
              onPressed: () {
            ...
            TextButton.icon(
              ...
              onPressed: () {
                ref.read(counterProvider.notifier).increateByOne();
              },
            ),
